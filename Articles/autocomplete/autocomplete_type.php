...
$result_msg_cont = "SELECT DISTINCT type FROM articles WHERE type LIKE '%".$type."%' ORDER BY type ASC LIMIT 5";
...
/*if (isset($_POST['query'])) {
    $type = $_POST['query'];
    $sql = 'SELECT DISTINCT type FROM articles WHERE type LIKE :type';
